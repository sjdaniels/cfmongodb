...
<cfscript>
    ...
    writedump(var:countsbyStatus,label:"Counts Using Group By", expand:false);    
</cfscript>
...
<cfscript>
    ...
    writedump(var:ageMellowing,label:"Average Age Of Mellowing Musicians", expand:false);    
</cfscript>
...
<cfscript>
    ...
    writedump(var:musiciansPerBand,label:"Band Members", expand:false);    
</cfscript>
...
<cfscript>
    ...
    writedump(var:musiciansCountsPerInstrument,label:"Musician Counts Per Instrument", expand:false);    
